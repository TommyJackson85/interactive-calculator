...
describe("displaySavedCalculations() outcomes", function(){
    it(`If there are no saved calculations it returns one list item in #displayedCalculationList saying 'No Calculations are saved.'`, function(){
        calculationsList = [];
        let displayedCalculationList = document.getElementById('displayedCalculationList');
    ...
    it(`displayedSavedCalculations() returns undefined when calculationsList is not empty;
        ...
        deleteCalc() returns listItemStatus.innerHTML = "Calculation data deleted!";
        ...
        loadCalc() returns listItemStatus.innerHTML = "Calculation data loaded succesfully!";
        loadCalc() also adds the 'success-border' class to dom elements #mainCalculator and #display;`
       , function(){
        calculation = [];
        newNumber = [];
        newOperator = [];
        ...
        let deleteCalc = document.getElementById("deleteCalc" + 1);
        ...
        let loadCalc = document.getElementById("loadCalc" + 1);
...
describe('clearPageAlerts() outcomes; clearPageAlerts() if called from all functions. It is designed clean all alerts or restart them.', function(){
    it(`Removes "success-border" class from #mainCalculator and #display DOM elements;
        ...
        expect(displaySavedCalculations()).toBe(undefined);
        let loadCalc = document.getElementById("loadCalc" + 0);
